...
/** Destaques da home (8 cards — mesma ordem do Home.tsx). */
export const HOME_FEATURED = {
  pt: [
    { slug: "cachoeira-almecegas-poco-sao-bento-guia-chapada-veadeiros", label: "Alto Paraíso", title: "Almécegas e Poço São Bento", meta: "Trilha fácil · 8 km" },
    { slug: "vale-lua-guia-chapada-veadeiros-sao-jorge", label: "São Jorge", title: "Vale da Lua", meta: "Trilha fácil · 32 km" },
    { slug: "cataratas-dos-couros-guia-chapada-veadeiros-alto-paraiso", label: "Aventura", title: "Cataratas dos Couros", meta: "Trilha difícil · guia recomendado" },
    { slug: "cachoeira-santa-barbara-guia-chapada-veadeiros-cavalcante", label: "Cavalcante", title: "Cachoeira Santa Bárbara", meta: "Trilha mediana · 130 km" },
    { slug: "cachoeira-segredo-guia-chapada-veadeiros-sao-jorge", label: "São Jorge", title: "Cachoeira do Segredo", meta: "Trilha mediana · 56 km" },
    { slug: "cachoeira-cristais-guia-chapada-veadeiros-alto-paraiso", label: "Alto Paraíso", title: "Cachoeira dos Cristais", meta: "Acesso fácil · família" },
    { slug: "cachoeira-poco-encantado-guia-chapada-veadeiros-teresina-de-goias", label: "Teresina de Goiás", title: "Poço Encantado", meta: "Trilha fácil · 53 km" },
    { slug: "cachoeira-macaquinhos-guia-chapada-veadeiros-sao-joao-alianca", label: "São João", title: "Macaquinhos", meta: "Trilha difícil · 44 km" },
  ],
  en: [
    { slug: "cachoeira-almecegas-poco-sao-bento-guia-chapada-veadeiros", label: "Alto Paraíso", title: "Almécegas & São Bento", meta: "Easy trail · 8 km" },
    { slug: "vale-lua-guia-chapada-veadeiros-sao-jorge", label: "São Jorge", title: "Moon Valley", meta: "Easy trail · 32 km" },
    { slug: "cataratas-dos-couros-guia-chapada-veadeiros-alto-paraiso", label: "Adventure", title: "Couros waterfalls", meta: "Hard trail · guide recommended" },
    { slug: "cachoeira-santa-barbara-guia-chapada-veadeiros-cavalcante", label: "Cavalcante", title: "Santa Barbara fall", meta: "Medium trail · 130 km" },
    { slug: "cachoeira-segredo-guia-chapada-veadeiros-sao-jorge", label: "São Jorge", title: "Secret waterfall", meta: "Medium trail · 56 km" },
    { slug: "cachoeira-cristais-guia-chapada-veadeiros-alto-paraiso", label: "Alto Paraíso", title: "Cristais waterfall", meta: "Easy access · families" },
    { slug: "cachoeira-poco-encantado-guia-chapada-veadeiros-teresina-de-goias", label: "Teresina de Goiás", title: "Enchanted Pool", meta: "Easy trail · 53 km" },
    { slug: "cachoeira-macaquinhos-guia-chapada-veadeiros-sao-joao-alianca", label: "São João", title: "Macaquinhos", meta: "Hard trail · 44 km" },
  ],
  es: [
    { slug: "cachoeira-almecegas-poco-sao-bento-guia-chapada-veadeiros", label: "Alto Paraíso", title: "Almécegas y São Bento", meta: "Sendero fácil · 8 km" },
    { slug: "vale-lua-guia-chapada-veadeiros-sao-jorge", label: "São Jorge", title: "Valle de la Luna", meta: "Sendero fácil · 32 km" },
    { slug: "cataratas-dos-couros-guia-chapada-veadeiros-alto-paraiso", label: "Aventura", title: "Cataratas de Couros", meta: "Sendero difícil · guía recomendado" },
    { slug: "cachoeira-santa-barbara-guia-chapada-veadeiros-cavalcante", label: "Cavalcante", title: "Cascada Santa Bárbara", meta: "Sendero medio · 130 km" },
    { slug: "cachoeira-segredo-guia-chapada-veadeiros-sao-jorge", label: "São Jorge", title: "Cascada del Secreto", meta: "Sendero medio · 56 km" },
    { slug: "cachoeira-cristais-guia-chapada-veadeiros-alto-paraiso", label: "Alto Paraíso", title: "Cascada de los Cristales", meta: "Acceso fácil · familia" },
    { slug: "cachoeira-poco-encantado-guia-chapada-veadeiros-teresina-de-goias", label: "Teresina de Goiás", title: "Pozo Encantado", meta: "Sendero fácil · 53 km" },
    { slug: "cachoeira-macaquinhos-guia-chapada-veadeiros-sao-joao-alianca", label: "São João", title: "Macaquinhos", meta: "Sendero difícil · 44 km" },
  ],
};
